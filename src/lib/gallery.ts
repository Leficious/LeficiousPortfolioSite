...
export const galleryEntries: GalleryEntry[] = [
  {
    id: "fallen-valkyrie-technical-design",
    title: "Fallen Valkyrie",
    description: "A focused action-combat prototype built around weapon-dependent movesets, directional hit reactions, lock-on targeting, and a multiphase boss encounter.",
    contribution: "Solo technical and combat design, Blueprint implementation, boss AI, animation systems, cinematics, and scene assembly",
    software: ["Unreal Engine"],
    year: "2025",
    tags: ["Technical Design", "Realtime", "Animations"],
    ...
    media: [
      { type: "image", src: "/projects/fallen-valkyrie/cover.avif", alt: "Fallen Valkyrie boss encounter gameplay" },
      { type: "youtube", url: "https://www.youtube.com/watch?v=b9TmdVsIF5s", title: "Fallen Valkyrie combat prototype" },
      { type: "image", src: "/projects/fallen-valkyrie/ai-statetree-01.avif", alt: "Fallen Valkyrie boss StateTree behavior structure" },
    ],
  },
  {
    id: "starshore-technical-design",
    title: "Starshore",
    description: "A gameplay prototype connecting character movement, abilities, targeting, inventory, shops, and reusable data-driven pickups into one playable loop.",
    contribution: "Solo technical game design, gameplay implementation, level design, UI, animation integration, and scene assembly",
    software: ["Unreal Engine"],
    year: "2025",
    tags: ["Technical Design", "Realtime", "Animations"],
    ...
    projectLabel: "View full project breakdown",
    media: [
      { type: "image", src: "/projects/starshore/design-layout-01.avif", alt: "Starshore playable environment and encounter space" },
      { type: "image", src: "/projects/starshore/abilities-01.avif", alt: "Starshore character attributes and ability configuration" },
      { type: "youtube", url: "https://www.youtube.com/watch?v=oDeL2cEAWg4", title: "Starshore uncut gameplay capture" },
    ],
  },
  {
    id: "grid-based-tactical-rpg-template",
    title: "Grid-Based Tactical RPG Template",
    description: "A reusable Unreal Engine tactical-grid framework featuring snappable grid authoring, traversal visualization, and pathfinding for grid-based movement.",
    contribution: "Technical game design, A* and Dijkstra pathfinding, UMG grid-generation tools, shared gameplay data structures, and reusable animation Blueprint templates",
    software: ["Unreal Engine"],
    year: "2026",
    tags: ["Technical Design", "Tools", "Realtime"],
  ...
  },
  {
    ...
    title: "Stylize Normals Toolkit",
    description: "A production-safe Maya toolkit for transferring, generating, previewing, inspecting, repairing, and comparing custom vertex normals across stylized assets.",
    contribution: "Python and Maya API development, UX and workflow design, testing, and documentation",
    software: ["Maya", "Python"],
    year: "2025",
    tags: ["Tools", "3D", "Environment"],
    cover: "/gallery/tools/stylize-normals-toolkit/menus.avif",
    coverAlt: "Stylize Normals Toolkit interface and production features",
    aspect: "landscape",
    projectUrl: "https://github.com/Leficious/MayaStylizedNormalsToolkit",
    projectLabel: "View toolkit on GitHub",
    pinned: true,
    media: [
      { type: "image", src: "/gallery/tools/stylize-normals-toolkit/menus.avif", alt: "Stylize Normals Toolkit interface and production features" },
      { type: "image", src: "/gallery/tools/stylize-normals-toolkit/vertex-normals-comparison.avif", alt: "Stylized foliage before and after custom vertex normals are applied" },
      { type: "youtube", url: "https://www.youtube.com/watch?v=ZznAb_eyiLo", title: "Stylize Normals Toolkit demonstration" },
    ],
  },
  {
    id: "hotel-room",
